...
<body>
    <div class="first-image navbar-color">
        <nav class="navbar navbar-expand-lg navbar-light static-top" style="background-color: rgba(0,0,0,0.7);">
            <div class="container">
        ...
        <div class="text-center image-title">
            <div class="text-title col-md-12">
                <h1 class="animated fadeInUp">Find Your Ideal Hostel </h1>
            </div>
            <button type="button" class="btn btn-warning btn-lg button" onclick="window.location.href = 'hostel_page.html'">Search Now</button>
        </div>
    </div>
